...
#    Updated: 2022/04/07 22:17:29 by mcesar-d         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			=	ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_atoi.c \
					...
					ft_strchr.c ft_strrchr.c ft_strncmp.c ft_strlcpy.c ft_memset.c \
					ft_memcmp.c ft_memcpy.c ft_memchr.c ft_memmove.c
OBJS			=	$(SRCS:.c=.o)
CC				=	cc
